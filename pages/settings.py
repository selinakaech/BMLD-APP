...
# Einstellungsseite
def einstellungen():
    st.title("⚙️ Personalisierung der App")
    ...
    if submit:
        ...
        st.success("Einstellungen gespeichert! Bitte lade die Seite neu.")
 
# Anwenden der globalen Einstellungen auf den Hauptbereich (nicht auf das Formular)
main_style = f"<style>div.block-container {{ background-color: {st.session_state['background_color']}; font-family: {st.session_state['font']}; }}</style>"
st.markdown(main_style, unsafe_allow_html=True)
 
# Animationseffekt direkt überall
