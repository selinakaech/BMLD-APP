...
# Deine Bild-URL
image_url = "https://cdn.pixabay.com/photo/2013/11/24/11/10/lab-217043_1280.jpg"
...
if masse > 0 and molare_masse > 0:
    ...
    st.error("❗ Bitte stellen Sie sicher, dass sowohl die Masse als auch die Molmasse grösser als 0 sind.")
